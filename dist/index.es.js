...
class LinkedListErrors extends Error {
    constructor(message) {
        super(message);
...
class UnionFindError extends Error {
    constructor(message) {
        super(message);
...
export { DoublyLinkedList, LinkedList, PriorityQueue, Queue, Stack$1 as Stack, StaticQueue, UnionFind };
